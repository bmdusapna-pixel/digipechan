...
import {
  ...
  rangedRevenue,
  weeklyRevenueTrend,
} from "../../controllers/admin/analytics/adminController";
...
import {
  ...
  getSalespersonBundleDetails,
  transferBundleToSalesperson,
} from "../../controllers/admin/salesperson/salespersonManagementController";
import {
  getCustomerData,
  viewMoreCustomerData,
  updateCustomerData,
  updateViewMoreData,
} from "../../controllers/admin/customer-mgmt/customerManagementController";
import {
...
adminRoute.get("/share/bundles/:token", downloadSharedBundle);
...
adminRoute.put(
  "/salesperson/:salespersonId/password",
  authenticate,
  authorize([UserRoles.ADMIN]),
  updateSalespersonPassword
);
adminRoute.put(
  "/salesperson/:salespersonId/toggle-status",
  authenticate,
  authorize([UserRoles.ADMIN]),
  toggleSalespersonStatus
);
...
adminRoute.get(
  "/salesperson/:salespersonId/customers",
  authenticate,
  authorize([UserRoles.ADMIN]),
  getSalespersonCustomers
);
adminRoute.get(
  "/salesperson/:salespersonId/bundles",
  authenticate,
  authorize([UserRoles.ADMIN]),
  getSalespersonBundleDetails
);
adminRoute.put(
  "/bundles/:bundleId/transfer",
  authenticate,
  authorize([UserRoles.ADMIN]),
  transferBundleToSalesperson
);
...
adminRoute.put(
  "/payment-tickets/:ticketId/status",
  authenticate,
  authorize([UserRoles.ADMIN]),
  updatePaymentTicketStatus
);
