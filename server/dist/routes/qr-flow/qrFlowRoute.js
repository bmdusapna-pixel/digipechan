...
exports.qrFlowRoute.get("/scan/:qrId/questions", jwtAuthenticationMiddleware_1.authenticate, (0, jwtAuthenticationMiddleware_1.authorize)([enums_1.UserRoles.BASIC_USER]), qrQuestionsController_1.getScanQuestions);
...
exports.qrFlowRoute.delete("/qr/:qrId/reviews/:reviewId", jwtAuthenticationMiddleware_1.authenticate, (0, jwtAuthenticationMiddleware_1.authorize)([enums_1.UserRoles.BASIC_USER, enums_1.UserRoles.ADMIN]), qrReviewController_1.deleteQRReview);
