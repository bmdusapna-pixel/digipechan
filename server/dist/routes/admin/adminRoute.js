...
exports.adminRoute.post("/bundles/:bundleId/share", jwtAuthenticationMiddleware_1.authenticate, (0, jwtAuthenticationMiddleware_1.authorize)([enums_1.UserRoles.ADMIN]), orderManagementController_1.generateShareLink);
exports.adminRoute.get("/share/bundles/:token", orderManagementController_1.downloadSharedBundle);
...
exports.adminRoute.put("/salesperson/:salespersonId/toggle-is-verified", jwtAuthenticationMiddleware_1.authenticate, (0, jwtAuthenticationMiddleware_1.authorize)([enums_1.UserRoles.ADMIN]), salespersonController_1.toggleSalespersonVerification);
