...
exports.authRoute.put('/profile', jwtAuthenticationMiddleware_1.authenticate, (0, jwtAuthenticationMiddleware_1.authorize)([enums_1.UserRoles.BASIC_USER]), multerConfig_1.upload.single('avatar'), passwordAuthenticationMiddleware_1.default, authController_1.updateUserProfile);
exports.authRoute.put('/profile/reset', jwtAuthenticationMiddleware_1.authenticate, (0, jwtAuthenticationMiddleware_1.authorize)([enums_1.UserRoles.BASIC_USER]), passwordAuthenticationMiddleware_1.default, authController_1.resetUserProfile);
exports.authRoute.post('/pin', jwtAuthenticationMiddleware_1.authenticate, (0, jwtAuthenticationMiddleware_1.authorize)([enums_1.UserRoles.BASIC_USER, enums_1.UserRoles.SALESPERSON, enums_1.UserRoles.ADMIN]), authController_1.setPin);
