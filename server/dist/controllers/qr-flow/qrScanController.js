...
exports.scanQrHandler = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const ownerId = (_b = (_a = qr.createdFor) === null || _a === void 0 ? void 0 : _a._id) === null || _b === void 0 ? void 0 : _b.toString();
        if (ownerId) {
    ...
    const reviewStats = {
        ...
        averageRating: reviews.length > 0
            ? Math.round((reviews.reduce((sum, r) => sum + (r.rating || 5), 0) /
                reviews.length) *
                10) / 10
            : 0,
...
exports.startCallHandler = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        let notificationSent = false;
        if (ownerId) {
            const owner = yield user_1.User.findById(ownerId.toString())
                .select("deviceTokens")
                .lean();
            const tokens = (owner === null || owner === void 0 ? void 0 : owner.deviceTokens) || [];
            if (tokens.length > 0) {
