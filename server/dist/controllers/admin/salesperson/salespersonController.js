...
exports.toggleSalespersonVerification = exports.toggleSalespersonStatus = exports.updateSalesperson = exports.updateSalespersonPassword = exports.createSalesperson = void 0;
...
exports.toggleSalespersonVerification = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { salespersonId } = req.params;
        const salesperson = yield salesman_1.Salesman.findById(salespersonId);
        if (!salesperson) {
        ...
        const updatedSalesperson = yield salesman_1.Salesman.findByIdAndUpdate(salespersonId, { $set: { isVerified: !salesperson.isVerified } }, { new: true, select: "-password" });
        return (0, ApiResponse_1.ApiResponse)(res, 200, `Salesperson ${(updatedSalesperson === null || updatedSalesperson === void 0 ? void 0 : updatedSalesperson.isVerified) ? "verified" : "unverified"} successfully`, true, updatedSalesperson);
    }
    catch (error) {
        console.error("Error toggling salesperson verification:", error);
        return (0, ApiResponse_1.ApiResponse)(res, 500, "Failed to update salesperson verification", false, null);
    }
}));
